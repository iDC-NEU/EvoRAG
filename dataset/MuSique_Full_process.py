...
MUSIQUE_FULL_PATH = os.path.join(Path(__file__).parent, "musique", "musique_full_v1.0_dev.jsonl")
MUSIQUE_FULL_RANDOM_1200_PATH = os.path.join(Path(__file__).parent, "musique", "musique_full_v1.0_dev_1200.jsonl")

class Musique_full_dataset:
    def __init__(self):
        self.corpus = []
        self.query = []
        self.answer = []
    ...
    def random_1200(self):
        if os.path.exists(MUSIQUE_FULL_RANDOM_1200_PATH):
            return
        
        all_data = []
        with open(MUSIQUE_FULL_PATH, 'r', encoding='utf-8') as file:
            count = 0
            for line in file:
                # if count >= 1:
                #     break
        ...
        with open(MUSIQUE_FULL_RANDOM_1200_PATH, 'w', encoding='utf-8') as file:
    ...
    def read(self):
        count = 0
        with open(MUSIQUE_FULL_RANDOM_1200_PATH, 'r', encoding='utf-8') as file:
            for line in file:
